const fs = require('fs-extra') 
 ...
 global.sudo = process.env.SUDO || '2348160208114' 
 global.devs = '2348160208114'; 
 global.website = 'https://github.com/' //wa.me/+91000000000000 
 global.THUMB_IMAGE = process.env.THUMB_IMAGE || '' 
 module.exports = { 
   botname:   process.env.BOT_NAME === undefined ? 'ＣＬＩＮＴＯＮ ＢＯＴ' : process.env.BOT_NAME, 
   ownername: process.env.OWNER_NAME === undefined ? 'ＣＬＩＮＴＯＮ™' : process.env.OWNER_NAME,  
